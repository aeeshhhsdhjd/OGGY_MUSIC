...
OWNER_ID = int(getenv("OWNER_ID", 8477195695))

HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://BGMI_MAIN9050")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BGMI_MAIN9050")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/BAN9B")
